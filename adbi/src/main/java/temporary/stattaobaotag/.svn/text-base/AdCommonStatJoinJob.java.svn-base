...
import temporary.stattaobaotag.AdCommonStatJoinMapper;
import temporary.stattaobaotag.AdCommonStatJoinReducer;


@SuppressWarnings("deprecation")
public class AdCommonStatJoinJob extends Configured implements Tool{
	
	final String JOB_NAME = "ADBI_AdCommonStatJoinJobTaobaoTagUV";
